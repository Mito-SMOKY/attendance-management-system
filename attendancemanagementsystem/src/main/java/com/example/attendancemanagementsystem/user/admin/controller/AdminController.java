...
public class AdminController {
    ...
    @GetMapping("/creation_history")
    public String showCreationHistory() {
        return "admin/creation_history";
    }

    @GetMapping("/file_read_result")
    public String showFileReadResultPage() {
        return "admin/file_read_result";
    }

    @GetMapping("/manual_input")
    public String showManualInput() {
        return "admin/manual_input";
    }

    @GetMapping("/manual_result")
    public String showManualResult() {
        return "admin/manual_result";
    }

    @GetMapping("/attendance_information")
    public String showAttendanceInformation() {
        return "admin/attendance_information";
    }

    @GetMapping("/temp_account_list")
    public String showTempAccountListPage() {
        return "admin/temp_account_list";
    }

    @GetMapping("/sadminEmergencyMain")
    public String showEmergencyMainPage() {
        return "admin/sadminEmergencyMain";
    }
